...
<head>
    ...
    <link href="<?= base_url() ?>assets/bs3/css/bootstrap-reset.css" rel="stylesheet">
    <link href="<?= base_url() ?>assets/font-awesome/css/font-awesome.css" rel="stylesheet" />

    <!-- Custom styles for this template -->
    <link href="<?= base_url() ?>assets/bs3/css/style.css" rel="stylesheet">
    <link href="<?= base_url() ?>assets/bs3/css/style-responsive.css" rel="stylesheet" />
  ...
  <body class="login-body">
    ...
    <!--Core js-->
    <script src="<?= base_url() ?>assets/bs3/js/jquery.js"></script>
